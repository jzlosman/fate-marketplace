module.exports = function ( grunt ) {
    ...
    var taskConfig = {
        ...
        delta: {
            ...
            assets: {
                ...
                tasks: [ 'copy:build_app_assets', 'copy:build_vendor_assets', 'copy:build_app_tpls' ]
            },
    ...
    grunt.registerTask( 'build', [
        'clean', 'bower:dev', 'html2js', 'coffee', 'sass:build', /* 'jshint', 'coffeelint' */
        'concat:build_css', 'copy:build_app_assets', 'copy:build_vendor_assets', 'copy:build_app_tpls',
    ...
    grunt.registerMultiTask( 'index', 'Process index.html template', function () {
        ...
        grunt.file.copy('src/index.ejs', this.data.dir + '/index.ejs', {
